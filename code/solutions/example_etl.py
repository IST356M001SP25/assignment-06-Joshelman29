...
LOCATION_SOURCE_FILE = "code/solutions/cache/locations.csv"
GEOCODE_CACHE_FILE = "code/solutions/cache/geocoded_locations.csv"
WEATHER_CACHE_FILE = "code/solutions/cache/weather_locations.csv"
